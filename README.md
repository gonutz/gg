...
## Installation
    ...
    go install github.com/gonutz/gg@latest

## Documentation

- godoc: https://godoc.org/github.com/gonutz/gg
- pkg.go.dev: https://pkg.go.dev/github.com/gonutz/gg?tab=doc
...
There are [lots of examples](https://github.com/gonutz/gg/tree/master/examples) included. They're mostly for testing the code, but they're good for learning, too.
